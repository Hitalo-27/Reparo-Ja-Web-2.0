	...
	<main class="contact">
		<div class="contactForm">
			<form action="cadastrarPrestador" method="POST">
				...
				<div class="tipoPres">
					<input type="checkbox" name="eletrodomesticos"
						id="eletrodomesticos" /> <label for="eletrodomesticos">Eletrodomesticos</label>
					<i class="fas fa-car-battery eletro"></i> <input type="checkbox"
						name="pintor" id="pintor" /> <label for="pintor">Pintor</label> <i
						class="fas fa-paint-roller pintor"></i>

				</div>

				<div class="tipoPres">
					<input type="checkbox" name="marceneiro" id="marceneiro" /> <label
						for="marceneiro">Marceneiro</label> <i
						class="fas fa-tools marceneiro"></i> <input class="eletricista"
						type="checkbox" name="eletricista" id="eletricista" /> <label
						for="eletricista">Eletricista</label> <i class="fas fa-bolt"></i>

				</div>

				<div class="tipoPres">
					<input type="checkbox" name="pedreiro" id="pedreiro" /> <label
						for="pedreiro">Pedreiro</label> <i
						class="fas fa-th-large pedreiro"></i> <input class="encanador"
						type="checkbox" name="encanador" id="encanador" /> <label
