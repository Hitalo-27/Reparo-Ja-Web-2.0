...
<body>
			...
			<tr>
				...
				<td>
					<div class="bodyQuemSomos">
						...
						segundo avaliação técnica, geolocalização entre outros. <br /> <br />
	...
	<div class="boxImgMobile">
		...
		<div class="bodyQuemSomos">
			...
			geolocalização entre outros. <br /> <br /> Reparo já foi
			desenvolvido depois da percepção dos fundadores da empresa Quazar na
			debilidade entre segurança e serviço de qualidade. Estamos
			trabalhando com tecnologia de ponta para facilitar seu cotidiano,
			tornando mais rápido aquilo que demandaria um tempo de busca e
			análise da partes dos usuários, nós nos diferenciamos pela agilidade
			no processo de interação e comunicação com o profissional autônomo e
			o cliente, deixando assim o sistema mais dinâmico para o público,
			fazendo ter econômia de tempo, por uma pesquisa da empresa Quazar,
			observamos que 78% das pessoas procuram concertar os
	...
	<div class="titleAvaliacao">
		<h1>Principios da empresa Quazar</h1>
	</div>
	...
	<section class="cards-wrapper">
		<div class="card-grid-space">
			<div class="card-container">
				...
				<p>Reparo já tem por objetivo contribuir para empregabilidade de
					sujeitos autônomos e segurança aos cidadãos no momento de solicitar
					um profissional em reparos domésticos.</p>
			</div>
		</div>
		...
		<div class="card-grid-space">
			<div class="card-container">
				...
				<h3>Visão</h3>
				<p>Melhorar seu cotidiano com a facilidade em encontrar um
					profissional em reparos domésticos qualificado com segurança,
					eficiência, rapidez, e sem sair de casa. Procurar contribuir com a
					solução para seus problemas em busca de técnicos perto da sua
					localização. Nossa visão é sempre contribuir para melhorar seu
					cotidiano para melhor através da tecnologia.</p>
			</div>
		</div>
	</section>
