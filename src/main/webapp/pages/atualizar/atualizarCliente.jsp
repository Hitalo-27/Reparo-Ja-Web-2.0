					...
					<div>
						...
						<div class="inputBox">
							<input type="text" name="nome"
								value="<%= cliente.getUser().getNome()%>" /> <span>Nome
								completo</span>
						</div>
						...
						<div class="inputBox">
							<input type="number" name="cep"
								value="<%= cliente.getUser().getCep()%>" /> <span>CEP</span>
						</div>

						<div class="inputBox">
							<input type="text" name="rua"
								value="<%= cliente.getUser().getRua()%>" /> <span>Rua</span>
						</div>

						<div class="inputBox">
							<input type="number" name="idade"
								value="<%= cliente.getUser().getIdade()%>" /> <span>Idade</span>
						</div>
					...
					<div class="formDireita">
						...
						<div class="inputBox">
							<input type="email" name="email"
								value="<%= cliente.getUser().getEmail()%>" /> <span>Email</span>
						</div>

						<div class="inputBox">
							<input type="number" name="cpf"
								value="<%= cliente.getUser().getCpf()%>" /> <span>CPF</span>
						</div>
						...
						<div class="inputBox">
							<input type="password" name="senha"
								value="<%= cliente.getUser().getSenha()%>" /> <span>Senha</span>
						</div>
