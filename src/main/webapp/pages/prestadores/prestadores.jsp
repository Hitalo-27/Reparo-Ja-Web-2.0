...
<%@ page import="com.quazar.tcc.service.ServicosPrestadorService"%>
<%@ page import="com.quazar.tcc.dao.ServicosPrestadorDao"%>
<%@ page import="java.util.ArrayList"%>
<%@ page import="java.util.List"%>

<%
	@SuppressWarnings("unchecked")
	List<PrestadorServico> listaPrestadores = (ArrayList<PrestadorServico>) request.getAttribute("prestadoresServico");
	...
	<div class="containerAnuncio">
		...
		<div class="search">
			<nav class="main-incline">
				...
				<form id="form-inline-main" class="form-inline" action="buscarPrestador" method="post">
				  <input id="form-inline-input"  class="form-control mr-sm-2" type="search" name="pesquisaPrestador" placeholder="Pesquisar" aria-label="Pesquisar">
...
<div style="margin-bottom: 5rem;" class="panel panel-default">
	...
	<div id="collapseG" class="panel-collapse collapse in show">
		...
		<div class="panel-body">
			...
			<section class="cards-wrapper">
				<%
				try {
					for (PrestadorServico prestadorServico : listaPrestadores) {
				%>
					...
					<div class="card-grid-space">
						<div class="card-container">
								<img class="round"
								src="../../upload/<%=prestadorServico.getUser().getFoto()%>" alt="user" />
		
							<h3 style="color: #FFFFFF;"> <i class="fas fa-user" ></i> <%=prestadorServico.getUser().getNome()%></h3>
							<h6>
								<i class="fas fa-map-marker-alt"></i>
								<%=prestadorServico.getUser().getBairro()%>,
								<%=prestadorServico.getUser().getRua()%></h6>
								<h6> <i class="fas fa-envelope"></i> <%=prestadorServico.getUser().getEmail()%></h6>
								<p></p>
							...
							<div class="buttons">
								<button class="primary" onclick="openModal(<%= prestadorServico.getId()%>)">Fazer pedido </button>
							</div>
							...
							%>
							<div class="buttons">
								<button class="primary"> <a href="deletarPrestador?id=<%=prestadorServico.getId()%>"> Excluir </a> </button>
							</div>
							...
							<div class="skills">
								...
								<ul>
									<li><%
										List<ServicosPrestador> servicosPrestadores = servicosPrestadorService
																.selectServicosPrestadorByIdPrestador(prestadorServico.getId());
										for(ServicosPrestador servicosPrestador : servicosPrestadores){
											out.print(servicosPrestador.getServico().getNome() + " || ");
										}
									%></li>
								</ul>
							</div>
...
<h1 style="padding: 2rem;" class="categoriasDisponiveis">Busca por categoria</h1>
			...
			<section class="cards-wrapper">
				...
				try {
					for (ServicosPrestador servicosPrestador : listaServicosPrestador) {
						if(servicosPrestador.getServico().getNome().equals("eletrodomesticos")){
				%>
				...
				<div class="card-grid-space">
						<div class="card-container">
								<img class="round"
								src="../../upload/<%=servicosPrestador.getPrestadorServico().getUser().getFoto()%>" alt="user" />
		
							<h3 style="color: #FFFFFF;"> <i class="fas fa-user" ></i> <%=servicosPrestador.getPrestadorServico().getUser().getNome()%></h3>
							<h6>
								<i class="fas fa-map-marker-alt"></i>
								<%=servicosPrestador.getPrestadorServico().getUser().getBairro()%>,
								<%=servicosPrestador.getPrestadorServico().getUser().getRua()%></h6>
								<h6> <i class="fas fa-envelope"></i> <%=servicosPrestador.getPrestadorServico().getUser().getEmail()%></h6>
								<p></p>
							...
							<div class="buttons">
								<button class="primary" onclick="openModal(<%= servicosPrestador.getPrestadorServico().getId()%>)">Fazer pedido </button>
							</div>
							...
							%>
							<div class="buttons">
								<button class="primary"> <a href="deletarPrestador?id=<%=servicosPrestador.getPrestadorServico().getId()%>"> Excluir </a> </button>
							</div>
							...
							<div class="skills">
								...
								<ul>
									<li><%
										List<ServicosPrestador> servicosPrestadores = servicosPrestadorService
																.selectServicosPrestadorByIdPrestador(servicosPrestador.getPrestadorServico().getId());
										for(ServicosPrestador servPrestador : servicosPrestadores){
											out.print(servPrestador.getServico().getNome() + " || ");
										}
									%></li>
								</ul>
							</div>
	...
	<div id="collapseA" class="panel-collapse collapse in">
		...
		<div class="panel-body">
			<section class="cards-wrapper">
				...
				try {
					for (ServicosPrestador servicosPrestador : listaServicosPrestador) {
						if(servicosPrestador.getServico().getNome().equals("eletricista")){
				%>
	...
	<div id="collapseB" class="panel-collapse collapse">
		<div class="panel-body">
			<section class="cards-wrapper">
				...
				try {
					for (ServicosPrestador servicosPrestador : listaServicosPrestador) {
						if(servicosPrestador.getServico().getNome().equals("pedreiro")){
				%>
	...
	<div id="collapseC" class="panel-collapse collapse">
		<div class="panel-body">
			<section class="cards-wrapper">
				...
				try {
					for (ServicosPrestador servicosPrestador : listaServicosPrestador) {
						if(servicosPrestador.getServico().getNome().equals("pintor")){
				%>
	...
	<div id="collapseD" class="panel-collapse collapse in">
		<div class="panel-body">
			<section class="cards-wrapper">
				...
				try {
					for (ServicosPrestador servicosPrestador : listaServicosPrestador) {
						if(servicosPrestador.getServico().getNome().equals("marceneiro")){
				%>
	...
	<div id="collapseE" class="panel-collapse collapse in">
		...
		<div class="panel-body">
			<section class="cards-wrapper">
				...
				try {
					for (ServicosPrestador servicosPrestador : listaServicosPrestador) {
						if(servicosPrestador.getServico().getNome().equals("encanador")){
				%>
