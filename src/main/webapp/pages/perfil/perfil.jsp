...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../../pages/perfil/perfil.css" />
    ...
    <section class="seccion-perfil-usuario">
      ...
      <div class="perfil-usuario-body">
        <div class="perfil-usuario-bio">
          ...
          <p class="texto">
            Descrição do perfil a se criar, procura-se técnicos para arrumar
            minha geladeira , na região de Guaianases, Zona Leste de São Paulo.
          </p>
        </div>
        <div class="perfil-usuario-footer">
          ...
          <ul class="lista-datos">
            ...
            <li>
            	...
            	<%= prestadorServico.getQtdeFuncionarios() %>
            </li>
			<%
				}
            %>
        ...
        <div class="redes-sociales">
          <a href="#">
            <i class="boton-redes instagram fas fa-cogs"></i>
          </a>
        </div>
      </div>
